...
[4] When you are browsing any website needs to be added to PAC list, simply copy it from browser address bar and press "shift + ctrl + ins" hotkey, the address will be added to PAC list of v2rayN and service will be automatically restarted. Also you can use "shift + ctrl + del" to remove this site from PAC list.</br>
[4] 当你在PAC模式下使用v2rayN时，如果觉得某个网址需要使用v2rayN访问，只需从浏览器地址栏复制网址，然后按下"shift + ctrl + ins"组合键，即可自动添加到v2rayN访问列表。也可使用"shift + ctrl + del"移除此网站。</br></br>
